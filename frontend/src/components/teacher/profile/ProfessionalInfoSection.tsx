...
export default function ProfessionalInfoSection({
  form, errors, subjects, subjectsLoading, onChange, onToggleSubject,
}: Props) {
  return (
    <View style={styles.card}>
      ...
      <TextInput
        ...
        onChangeText={onChange('otherSubject')}
        mode="outlined"
      ...
      <TextInput
        ...
        onChangeText={onChange('experience')}
        mode="outlined"
