...
export default function OnboardingScreen() {
  ...
  return (
    ...
    >
      <ScrollView
        contentContainerStyle={{ flexGrow: 1, backgroundColor: "#F5F8FA" }}
      ...
      >
        ...
        >
          ...
          >
            Browse hundreds of verified teachers across Ghana. Search directly
            from our platform.
          </Text>
        </View>
          ...
          <View style={{ width: "100%", maxWidth: 480, paddingHorizontal: 24 }}>
            ...
            >
              ...
              <TouchableOpacity onPress={() => navigation.navigate("Register")}>
                <Text
                  style={{ fontSize: 14, color: PRIMARY, fontWeight: "700" }}
                >
                  Register
                </Text>
              </TouchableOpacity>
