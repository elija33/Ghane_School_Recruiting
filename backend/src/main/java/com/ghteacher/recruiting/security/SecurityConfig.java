package com.ghteacher.recruiting.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/subscriptions/status").hasRole("SCHOOL")
                .requestMatchers("/api/subscriptions/initialize").hasRole("SCHOOL")
                .requestMatchers("/api/subscriptions/verify").hasRole("SCHOOL")
